      ...
      <div className='container mx-auto px-6'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          <div>
            ...
            <p className='text-sm'>
              Your ultimate pregnancy companion, providing support and guidance
          ...
          <div className='flex flex-col gap-2'>
            ...
            <a href='mailto:info@bhuth.org.ng' className='text-sm'>
              Email: info@bhuth.org.ng
            </a>
            <a href='tel:+2348181600465' className='text-sm'>
              Phone: +2348181600465
            </a>
          </div>
        ...
        <div className='mt-8 pt-8 border-t border-purple-800 text-center'>
          <p className='text-sm'>
            &copy; {new Date().getFullYear()} Mommy to Be. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
